                ...
                <div class="col-12 col-lg-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('createWhyus')}}" class="btn btn-default label-success">+ Add New</a>



                            <a href="{{route('viewWhyus')}}" class="btn btn-info label-success pull-right" > <i class="glyphicon glyphicon-eye-open"></i> views all</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <th>
                                                        <form action="{{route('showSchedule')."/".$key->whyus_id}}"
                                                        method="get">
                                                        <button type="submit" class="btn btn-info btn-xs">
                                                        <i class="fa fa-eye"></i>
                                                        </button>
                                                        ...
                                                        <th>
                                                            <form class="client" action="{{route('destroyWhyus')}}" method="post" onsubmit=" return ConfirmDelete()">
                                                                {{csrf_field()}}
                                                                <input type="hidden" name="id" value="{{$key->whyus_id}}">
                                                                <button type="submit" class="btn btn-danger btn-xs">
                                                                    <i class="fa fa-trash-o"></i>
