                ...
                <div class="col-12 col-lg-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('viewWhyus')}}" class="btn btn-info label-success pull-right"> <i
                                ...
                                <table id="example1"
                                    ...
                                    @foreach($items as $count => $key)
                                        <tr>
                                            <td>{{++$count}}</td>
                                            <td>{{$key->title}}</td>
                                            <td>{{str_limit($key->description,50)}}</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <form action="{{route('editWhyus')."/".$key->whyus_id}}"
                                                                  method="get">
                                                                <button type="submit" class="btn btn-success btn-xs">
                                                                    <i class="fa fa-pencil"></i>
                                                                </button>
                                                        ...
                                                        <th>
                                                            <form class="client" action="{{route('destroyWhyus')}}"
