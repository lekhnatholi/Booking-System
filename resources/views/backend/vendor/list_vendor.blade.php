                ...
                <div class="col-12 col-lg-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Vendor <strong></strong>&nbsp &nbsp                            </h3>

                            <a href="{{route('createVendor')}}" class="btn btn-default label-success">+ Add New</a>



                            <a href="{{route('viewVendor')}}" class="btn btn-info label-success pull-right" > <i class="glyphicon glyphicon-eye-open"></i> views all</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <th>
                                                            <form action="{{route('showVendor')."/".$key->vendors_id}}"
                                                                  method="get">
